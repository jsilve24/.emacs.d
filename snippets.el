...
\\end\\{figure\\}")
	    ...
	    (aas-set-snippets ,mode
	      ";inf" (jds~aas-insert-math "\\inf")
	      ";sup" (jds~aas-insert-math "\\sup")
	      ...
	      ";all" (jds~aas-insert-math "\\forall")
	      ";;a" (jds~aas-insert-math "\\alpha")
	      ";;b" (jds~aas-insert-math "\\beta")
	      ";;B" (jds~aas-insert-math "\\Beta")
	      ";;c" (jds~aas-insert-math "\\chi")
	      ";;d" (jds~aas-insert-math "\\delta")
	      ";;D" (jds~aas-insert-math "\\Delta")
	      ";;;d" (jds~aas-insert-math "\\partial")
	      ";;;D" (jds~aas-insert-math "\\nabla")
	      ";;e" (jds~aas-insert-math "\\epsilon")
	      ";;E" (jds~aas-insert-math "\\Epsilon")
	      ";;;e" (jds~aas-insert-math "\\varepsilon")
	      ";;f" (jds~aas-insert-math "\\phi")
	      ";;;f" (jds~aas-insert-math "\\varphi")
	      ";;F" (jds~aas-insert-math "\\Phi")
	      ";;g" (jds~aas-insert-math "\\gamma")
	      ";;G" (jds~aas-insert-math "\\Gamma")
	      ";;h" (jds~aas-insert-math "\\eta")
	      ";;H" (jds~aas-insert-math "\\Eta")
	      ";;k" (jds~aas-insert-math "\\kappa")
	      ";;;k" (jds~aas-insert-math "\\varkappa")
	      ";;l" (jds~aas-insert-math "\\lambda")
	      ";;;l" (jds~aas-insert-math "\\ell")
	      ";;L" (jds~aas-insert-math "\\Lambda")
	      ";;m" (jds~aas-insert-math "\\mu")
	      ";;n" (jds~aas-insert-math "\\nu")
	      ";;N" (jds~aas-insert-math "\\N")
	      ";;o" (jds~aas-insert-math "\\omega")
	      ";;O" (jds~aas-insert-math "\\Omega")
	      ";;p" (jds~aas-insert-math "\\pi")
	      ";;;p" (jds~aas-insert-math "\\varpi")
	      ";;P" (jds~aas-insert-math "\\Pi")
	      ";;q" (jds~aas-insert-math "\\theta")
	      ";;;q" (jds~aas-insert-math "\\vartheta")
	      ";;Q" (jds~aas-insert-math "\\Theta")
	      ";;s" (jds~aas-insert-math "\\sigma")
	      ";;;s" (jds~aas-insert-math "\\varsigma")
	      ";;S" (jds~aas-insert-math "\\Sigma")
	      ";;r" (jds~aas-insert-math "\\rho")
	      ";;R" (jds~aas-insert-math "\\R")
	      ";;t" (jds~aas-insert-math "\\tau")
	      ";;u" (jds~aas-insert-math "\\upsilon")
	      ";;U" (jds~aas-insert-math "\\Upsilon")
	      ";;v" "\\vert "
	      ";;x" (jds~aas-insert-math "\\xi")
	      ";;X" (jds~aas-insert-math "\\Xi")
	      ";;y" (jds~aas-insert-math "\\psi")
	      ";;Y" (jds~aas-insert-math "\\Psi")
	      ";;z" (jds~aas-insert-math "\\zeta")
	      ";;." (jds~aas-insert-math "\\cdot")
	      ";;;." (jds~aas-insert-math "\\circ")
	      ";;(" (jds~aas-insert-math "\\cup")
	      ";;)" (jds~aas-insert-math "\\cap")
	      ";;;(" (jds~aas-insert-math "\\bigcup")
	      ";;;)" (jds~aas-insert-math "\\bigcap")
	      ";;>" (jds~aas-insert-math "\\rightarrow")
	      ";;<" (jds~aas-insert-math "\\leftarrow")
	      ";;<" (jds~aas-insert-math "\\leftarrow")
	      ";;=" (jds~aas-insert-math "\\leftrightarrow")
	      ";;;>" (jds~aas-insert-math "\\Rightarrow")
	      ";;;<" (jds~aas-insert-math "\\Leftarrow")
	      ";;;<" (jds~aas-insert-math "\\Leftarrow")
	      ";;;=" (jds~aas-insert-math "\\Leftrightarrow")
	      ";;0" (jds~aas-insert-math "\\varnothing")
	      ";;^" (jds~aas-insert-math "\\uparrow")
	      ";;_" (jds~aas-insert-math "\\downarrow")
	      ";;8" (jds~aas-insert-math "\\infty")
	      ";;*" (jds~aas-insert-math "\\odot")
	      ";;/" (jds~aas-insert-math "\\oslash")
	      ";;+" (jds~aas-insert-math "\\oplus")
	      ";;-" (jds~aas-insert-math "\\ominus"))))
