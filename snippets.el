...
\\end\\{figure\\}")
	    ...
	    (aas-set-snippets ,mode
	      ...
	      ";reset" (jds~yas-lambda-expand "(-\\infty, \\infty)")
	    ...
	    (aas-set-snippets ,mode
	      ";lab"  (jds~yas-lambda-expand "\\label\\{$1\\}$0")
	      ...
	      ;; ";;K" (jds~aas-insert-math-symbol "Kappa")
	      ";;;k" (jds~aas-insert-math-symbol "varkappa")
	      ";;l" (jds~aas-insert-math-symbol "lambda")
	      ";;;l" (jds~aas-insert-math-symbol "ell")
	      ";;L" (jds~aas-insert-math-symbol "Lambda")
	      ...
	      ";;;p" (jds~aas-insert-math-symbol "varpi")
	      ";;P" (jds~aas-insert-math-symbol "Pi")
	      ";;q" (jds~aas-insert-math-symbol "theta")
	      ";;;q" (jds~aas-insert-math-symbol "vartheta")
	      ";;Q" (jds~aas-insert-math-symbol "Theta")
	      ";;s" (jds~aas-insert-math-symbol "sigma")
	      ";;;s" (jds~aas-insert-math-symbol "varsigma")
	      ";;S" (jds~aas-insert-math-symbol "Sigma")
	      ...
	      ";;/" (jds~aas-insert-math-symbol "oslash")
